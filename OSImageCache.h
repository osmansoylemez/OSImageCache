...
@protocol OSImageCacheDelegate <NSObject>

@optional
- (void) cache:(OSImageCache *)c didDownloadImage:(UIImage *)i forURL:(NSURL *)url;
- (void) cache:(OSImageCache *)c didDownloadImage:(UIImage *)i forURL:(NSURL *)url key:(NSString*)key;

@end

@interface OSImageCache : NSCache
